...
/**
 * REST controller for managing {@link com.cogitech.cyberax.server.domain.Gagnant}.
 */
@RestController
@RequestMapping("/api")
public class GagnantResource {
    ...
    public ResponseEntity<Gagnant> updateGagnant(@RequestBody Gagnant gagnant) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, gagnant.getId().toString()))
            .body(result);
    }
