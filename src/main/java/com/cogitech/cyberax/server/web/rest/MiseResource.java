...
/**
 * REST controller for managing {@link com.cogitech.cyberax.server.domain.Mise}.
 */
@RestController
@RequestMapping("/api")
public class MiseResource {
    ...
    public ResponseEntity<Mise> updateMise(@RequestBody Mise mise) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, mise.getId().toString()))
            .body(result);
    }
