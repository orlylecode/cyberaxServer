...
/**
 * REST controller for managing {@link com.cogitech.cyberax.server.domain.ListAttente}.
 */
@RestController
@RequestMapping("/api")
public class ListAttenteResource {
    ...
    public ResponseEntity<ListAttente> updateListAttente(@RequestBody ListAttente listAttente) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, listAttente.getId().toString()))
            .body(result);
    }
